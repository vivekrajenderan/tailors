                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-4">
                                <div class="pull-right"><button onclick="location.href = '<?php echo base_url() . "users/staffsalaryadd"; ?>';" type="button" class="btn bg-cyan waves-effect">Add Staff Salary</button></div>
                            </div>
                        </div>
                    </div>
                    <div class="body">
                        ...
                        <?php } ?>
                        <form id="orderform" method="POST" name="orderform" action="<?php echo base_url() . 'users/staffsalary/'; ?>" style="margin-bottom: 30px;">
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    <?php foreach ($balance_lists as $key => $lists) { ?>
                                        <tr>
                                            ...
                                            <td><?php if (empty($lists['status'])) {
                                            ?>
                                                    <a href="<?php echo base_url() . 'users/staffsalaryadd/' . md5($lists['id']); ?>" title="Edit" ><i class="material-icons" style="font-size: 20px;">edit</i></a>&nbsp;<a href="<?php echo base_url() . 'users/staffsalarydelete/' . md5($lists['id']); ?>" title="Delete" onclick="return confirm('Are you sure delete the data?')"><i class="material-icons" style="font-size: 20px;">delete</i></a>
                                                <?php } ?>
                                            </td>    
                                        </tr>       
                                    <?php } ?>
...
<script type="text/javascript">
                                    ...
                                    $(function () {
                                        ...
                                        $('.js-exportable').DataTable({
                                            ...
                                            "aoColumnDefs": [
                                                {'bSortable': false, 'aTargets': [4]}  //Not sorting the first and last columns
