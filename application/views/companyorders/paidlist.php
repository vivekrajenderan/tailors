                    ...
                    <div class="header">
                        <div class="row">
                            <div class="col-md-6 col-xs-8">
                                <h2>
                                    Company Paid Details (<?php echo isset($order_list[0]['orderno']) ? $order_list[0]['orderno'] : ""; ?>)
                                </h2>
        ...
        <div class="modal-content">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <form id="orderform" method="POST" name="orderform" action="<?php echo base_url() . 'companyorders/ajaxsavepaid/'; ?>">
...
<script type="text/javascript">
    function paiddetails(orderid = '', paidid)
    {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>companyorders/getpaiddetails",
