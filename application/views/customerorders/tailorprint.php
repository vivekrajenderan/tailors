    ...
    <body>
        ...
        <div id="page-wrap">
            ...
            <table cellspacing="10" cellpadding="0" width="100%" border="0" >
                ...
                <tr>
                    <td ><b>Name : </b></td>
                    <td ><?php echo isset($orders_list[0]['name']) ? $orders_list[0]['name'] : ""; ?></td>

                    <td ><b>Phone No : </b></td>
                    <td ><?php echo isset($orders_list[0]['mobileno']) ? $orders_list[0]['mobileno'] : ""; ?></td>
            ...
            <table cellspacing="10" cellpadding="0" width="100%" border="0">
                ...
                <tr>                    
                    <td ><b>Product Name : </b></td><td><?php echo isset($orders_list[0]['productname']) ? $orders_list[0]['productname'] : ""; ?></td>
                    <td ><b>Product Types : </b></td><td><?php
                        $type = array_column($typeresult, 'typename');
                        echo implode(", ", $type);
                        ?></td>                    
                    <td ><b>Quantity : </b></td><td><?php echo isset($orders_list[0]['quantity']) ? $orders_list[0]['quantity'] : ""; ?></td>                                       
                </tr>	
                <tr>
                    <?php
                    $m = 0;
                    foreach ($measurements as $key => $value) {
                        $m++;
                        echo '<td><b>' . $value['mname'] . '</b></td><td>' . $value['measurementvalue'] . '</td>';
            ...
            <p style="padding: 20px 5px;"><b>Description :</b> <?php echo isset($orders_list[0]['description']) ? $orders_list[0]['description'] : ""; ?></p>
