                                ...
                                <tbody>
                                    <?php foreach ($customer_lists as $key => $lists) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'customer/add/' . md5($lists['id']); ?>" title="Edit" ><i class="material-icons" style="font-size: 20px;">edit</i></a>&nbsp;<a href="<?php echo base_url() . 'customer/delete/' . md5($lists['id']); ?>" title="Delete" onclick="return confirm('Are you sure delete the data?')"><i class="material-icons" style="font-size: 20px;">delete</i></a>
                                            </td>                                        
