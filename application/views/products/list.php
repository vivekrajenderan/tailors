                    ...
                    <div class="header">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-4">
                                <div class="pull-right"><button onclick="location.href = '<?php echo base_url() . "products/add"; ?>';" type="button" class="btn bg-cyan waves-effect">Add Product</button></div>
                            </div>
                        </div>
                    </div>
                    <div class="body">
...
<!--                                            <td><?php
                                                if (isset($lists['product_image']) && !empty($lists['product_image'])) {
                                                    if (file_exists("./upload/products/" . $lists['product_image'])) { ?>
                                                        <img class="img-thumbnail" src="<?php echo base_url() . 'upload/products/' . $lists['product_image']; ?>" alt="" width="100" height="100"/>
                                                   <?php }
                                                }
                                                ?></td>-->
                                            <td>
